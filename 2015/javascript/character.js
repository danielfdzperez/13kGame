...
Character.prototype.getSquarePoints = function(x, y, tile_size, dead){
	var obj = {}
	obj["down"]  = Math.floor((y+this.dimensions-1 + (dead||0))/tile_size)
	obj["up"]    = Math.floor((y-this.dimensions)/tile_size)
	obj["left"]  = Math.floor((x-this.dimensions)/tile_size)
	obj["right"] = Math.floor((x+this.dimensions-1 + (dead||0))/tile_size)
	return obj
}
